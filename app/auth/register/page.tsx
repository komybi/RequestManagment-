  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse animation-delay-2000"></div>
        <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse animation-delay-4000"></div>
      </div>
            ...
            <div className="p-8 lg:p-12">
              <div className="mb-10 space-y-3">
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-gray-600 text-sm">Create your komydochub account to request documents</p>
                </div>
              </div>
              <RegisterForm />
              <p className="text-center text-xs text-gray-500 mt-6">
                Already have an account? <Link href="/auth/login" className="text-blue-600 hover:underline">Sign in instead</Link>
              </p>
            </div>
              ...
              <div className="relative z-10 flex items-center justify-center h-full p-8">
                <div className="text-center space-y-6 text-white">
                  ...
                  <p className="text-white/90 max-w-sm mb-8">
                    Create your account and unlock powerful features for managing your academic documents efficiently.
                  </p>
                  <div className="space-y-3 bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-white font-medium">Easy registration</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 003.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 00.723 1.745 3.066 3.066 0 000 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 00-1.745.723H8.733a3.066 3.066 0 00-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 000-3.976 3.066 3.066 0 00.723-1.745zM16 9a4 4 0 11-8 0 4 4 0 018 0zM9 13a2 2 0 00-2 2v1a2 2 0 002 2h6a2 2 0 002-2v-1a2 2 0 00-2-2H9z" clipRule="evenodd" />
                        </svg>
                      </div>
